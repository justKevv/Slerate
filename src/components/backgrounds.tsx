...
const Bg4 = () => {
  return (
    <div className="absolute inset-0 h-full w-full dark:bg-background [background:radial-gradient(125%_125%_at_50%_20%,transparent_40%,#63e_100%)]"></div>
  );
};
...
const Bg6 = () => {
  return (
    <div className="absolute inset-0 h-full w-full dark:bg-background [background:radial-gradient(125%_125%_at_50%_-50%,#c7d2fe_40%,transparent_100%)] dark:[background:radial-gradient(125%_125%_at_50%_-50%,#6366f136_40%,transparent_100%)]"></div>
  );
};
